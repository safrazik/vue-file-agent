...
var vue_file_preview_component = normalizeComponent(
  ...
  vue_file_previewvue_type_template_id_6216a7d1_render,
  vue_file_previewvue_type_template_id_6216a7d1_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./src/lib/data-transfer.js
      ...
      var readEntries = function readEntries() {
        entryReader.readEntries(function (entries) {
          ...
          function () {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      ...
                      return _context.abrupt("return", readEntries());

                    case 4:
                      _context.next = 6;
                      return getEntries(entries[i]);

                    case 6:
                      entryFiles = _context.sent;
            ...
            return function iterateEntry(_x) {
...
/* harmony default export */ var vue_file_agent_mixin = ({
  ...
  methods: {
    ...
    drop: function drop(event) {
      ...
      getFilesFromDroppedItems(event.dataTransfer).then(function (files) {
