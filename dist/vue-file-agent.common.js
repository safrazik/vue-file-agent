...
__webpack_require__.d(components_namespaceObject, "VueFileIcon", function() { return VueFileIcon; });
__webpack_require__.d(components_namespaceObject, "VueFileAgent", function() { return VueFileAgent; });
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"8eb171d4-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/VueFileIcon.vue?vue&type=template&id=25035d49&
...
// CONCATENATED MODULE: ./src/components/VueFileIcon.vue?vue&type=template&id=25035d49&
...
var icons = {
  ...
  image: new SvgPath([// 'M100 100H0V0h100v100zM9.7 90h80.7V10H9.7',
  'm 40.400002,35 a 8,8 0 0 1 -8,8 8,8 0 0 1 -8,-8 8,8 0 0 1 8,-8 8,8 0 0 1 8,8 z', 'M78.9 47.3l-9.7-9.6L50 57l-9.6-9.7-19.3 19.3V73h57.8z'], '#5b2d8d'),
  doc: new SvgPath([// 'M27.6 27l7.9 29.7L45.2 27h9.5l9.8 29.7L72.4 27H85L71.2 73H59l-9-26.7L41 73H28.8L15 27h12.6z',
  ...
  markup: new SvgPath([// 'M23 75c-.5 0-1.1-.2-1.5-.6L13.1 66c-.8-.8-.8-2.1 0-3l8.4-8.4c.8-.8 2.1-.8 3 0 .8.8.8 2.1 0 3l-6.9 6.9 6.9 6.9c.8.8.8 2.1 0 3-.5.4-1 .6-1.5.6zm25 0c-.5 0-1.1-.2-1.5-.6-.8-.8-.8-2.1 0-3l6.9-6.9-6.9-6.9c-.8-.8-.8-2.1 0-3 .8-.8 2.1-.8 3 0l8.4 8.4c.8.8.8 2.1 0 3l-8.4 8.4c-.4.4-.9.6-1.5.6zm-16.7 4.1c-.2 0-.4 0-.7-.1-1.1-.4-1.7-1.5-1.3-2.6l8.4-25.1c.4-1.1 1.5-1.7 2.6-1.3 1.1.4 1.7 1.5 1.3 2.6l-8.4 25.1c-.2.9-1 1.4-1.9 1.4z',
  ...
  sheet: new SvgPath([// 'M46.8 49.2H59v8.1H46.8zm0 12.5H59v8.1H46.8zm0 12.4H59v8.1H46.8zm-16.5 0h12.2v8.1H30.3zm-16.5 0H26v8.1H13.8zm27.1-4.8l-8-10.1 7.3-9.2H33l-3.8 5-3.5-5h-7.5l7.4 9.4-7.8 9.9h7.3l4.1-5.5 4.1 5.5z',
  'M62.1 30.9h14.1v9.4H62.1zm0 14.5h14.1v9.4H62.1zm0 14.3h14.1v9.4H62.1zm-19.2 0H57v9.4H42.9zm-19 0H38v9.4H23.9zm19.2-14.2h14.1v9.4H43.1zm-19.2 0H38v9.4H23.9zm19.2-14.6h14.1v9.4H43.1zm-19.2 0H38v9.4H23.9z'], '#30723f'),
  presentation: new SvgPath([// 'M53 47.7H19c-1.7 0-3.1 1.4-3.1 3.1v21.8c0 1.7 1.4 3.1 3.1 3.1h14.2L31.8 81h-1.6c-.7 0-1.2.5-1.2 1.2s.5 1.2 1.2 1.2h11.5c.7 0 1.2-.5 1.2-1.2s-.5-1.2-1.2-1.2H40l-1.4-5.4H53c1.7 0 3.1-1.4 3.1-3.1V50.8c0-1.7-1.4-3.1-3.1-3.1zm.3 25.1H18.7V50.6h34.5l.1 22.2z',
  // 'M27.6 63.9h2.8v5.6h-2.8zm4.7-1.8h2.8v7.4h-2.8zm4.6-1.9h2.8v9.3h-2.8zm4.6-1.8h2.8v11.1h-2.8zm-.2-4.1L36.4 57l-3.6-1.2-6.1 3.3.9 1 5.4-2.8 3.6 1.2 5.6-3.1.9 1 2.1-3.5-4.8.3z',
  ...
  other: new SvgPath([// 'M14 48.9h37v4.3H14zm7 9.6h37v4.3H21zm-7 9.6h37v4.3H14zm7 9.6h37V82H21z',
  'M71 36.3L57.8 23.1c-.4-.4-.9-.6-1.4-.6h-26c-1.1 0-2 .9-2 2v51.1c0 1.1.9 2 2 2h39.3c1.1 0 2-.9 2-2V37.7c-.1-.5-.3-1-.7-1.4zm-3.9 2.3H55.5V27l11.6 11.6zm.1 34.5H32.8V26.9h18.5v13.3c0 1.4 1.2 2.6 2.6 2.6h13.3v30.3z']) // play: new SvgPath([
  // 	// 'M14 48.9h37v4.3H14zm7 9.6h37v4.3H21zm-7 9.6h37v4.3H14zm7 9.6h37V82H21z',
  // 	// 'M8 5v14l11-7z',
...
function getAverageRGB(pixels, pixelCount) {
  ...
  var blockSize = 5,
      // only visit every x pirxels. e.g: every 5 pixels
  defaultRGB = {
    r: 0,
    g: 0,
    b: 0
  ...
  length = pixels.length; // var pixelCount = pixels.length;
  ...
  request(method, url, formData = null, configureFn = null) {
    return new Promise((resolve, reject) => {
      ...
      request[loadEvent] = () => {
        ...
        var responseHeaders = request.getAllResponseHeaders(); // console.log('All response headers', responseHeaders);
...
class upload_helper_UploadHelper {
  ...
  upload(url, filesData, progressFn) {
    ...
    for (let i = 0; i < filesData.length; i++) {
      ...
      formData.append('file', fileData.file); // function updateOverallProgress(){
      //   var prgTotal = 0;
  ...
  deleteUpload(url, fileData) {
    return new Promise((resolve, reject) => {
      ...
      if (fileData.upload) {
        this.doDeleteUpload(url, fileData.upload, xhr => {}).then(result => {
          resolve(result);
        }, reject);
      }
    });
...
/* harmony default export */ var VueFileAgentvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    upload(url, filesData) {
      ...
      upload_helper.upload(url, validFilesData, overallProgress => {
        this.overallProgress = overallProgress;
      }).then(() => {// alert('file upload ok');
      }, err => {// alert('ERRR: ' + err);
      });
    },

    deleteUpload(url, fileData) {
      upload_helper.deleteUpload(url, fileData).then(result => {// console.log('where done?', result);
        // model.__meta__.isUploading = false;  
      }, err => {
        console.log(err);
        alert('not deleted'); // model.__meta__.isUploading = false;  
      });
    ...
    removeFileData(fileData) {
      ...
      console.log('the upload, xhr: ', fileData.upload, fileData.xhr); // if (fileData.xhr) {
      // 	fileData.xhr.abort();
      // 	console.log('xhr.readyState:', fileData.xhr.readyState);
      // }
...
var VueFileAgent_component = normalizeComponent(
  ...
  VueFileAgentvue_type_template_id_0af11020_render,
  VueFileAgentvue_type_template_id_0af11020_staticRenderFns,
  false,
  null,
  null,
  null
...
const install = (Vue, options = {}) => {
  for (let key in components_namespaceObject) {
...
/* concated harmony reexport VueFileIcon */__webpack_require__.d(__webpack_exports__, "VueFileIcon", function() { return VueFileIcon; });
/* concated harmony reexport VueFileAgent */__webpack_require__.d(__webpack_exports__, "VueFileAgent", function() { return VueFileAgent; });
