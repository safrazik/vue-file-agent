...
declare class UploadHelper {
    ...
    upload(url: string, headers: object, filesData: FileData[], createFormData?: CreateFormDataFn, progressFn?: (progress: number) => void, configureFn?: ConfigureFn): Promise<AjaxResponse[]>;
